 ...
 attributeState("default", label:'${currentValue}', unit:"")
    ...
    */  
     ...
     standardTile("armDisarm", "device.armDisarm", width: 2, height: 2) {
      ...
      standardTile("armStay", "device.armStay",  width: 2, height: 2) {
			state "unlite", label:'Armed Stay',backgroundColor: "#ffffff"
            state "lite", label:'Armed Stay',backgroundColor: "#4f9558"
	}	
      standardTile("armAway", "device.armAway",  width: 2, height: 2) {
    ...
    valueTile("lastAlertType", "device.lastAlertType", inactiveLabel: false, width: 4, height: 1) {
		...
		standardTile("dismissSwitch", "device.switch", width: 2, height: 2, canChangeIcon: true) { 
